...
export default function Task ({task, changeTaskStatus, deleteTask}: TaskItemProps) {
    ...
    return (
        <section className={style.task}>
            <div className={style.checkbox_task}>
                <div className={task.finished ? style.check_task : style.uncheck_task} onClick={handleChangeTaskStatus}>
                    <img src={checkedIcon} alt="Tarefa finalizada" title="Tarefa finalizada" />
                </div>                
            </div>
            <div className={task.finished ? style.description_task_finished : style.description_task}>
                <p>{task.description}</p>
            </div>
            <div className={style.remove_task}>
                <div className={style.btn_remove_task} onClick={handleDeleteTask}>
